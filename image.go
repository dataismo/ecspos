// stolen from https://github.com/hennedo/escpos/blob/master/bitimage.go
...
func getImagePrintableData(img image.Image) (xL byte, xH byte, yL byte, yH byte, data []byte) {
